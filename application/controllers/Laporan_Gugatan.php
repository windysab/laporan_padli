...
class Laporan_Gugatan extends CI_Controller
{
	...
	public function index()
	{
		...
		$data += [
			'total_perkara' => $this->M_laporan_gugatan->get_total_perkara($lap_bulan, $lap_tahun, $jenis_laporan),
			'total_dikabulkan' => $this->M_laporan_gugatan->get_total_dikabulkan($lap_bulan, $lap_tahun, $jenis_laporan),
			'total_ditolak' => $this->M_laporan_gugatan->get_total_ditolak($lap_bulan, $lap_tahun, $jenis_laporan),
			'total_dicabut' => $this->M_laporan_gugatan->get_total_dicabut($lap_bulan, $lap_tahun, $jenis_laporan),
		];
	...
	public function print_laporan()
	{
		...
		$data = [
			...
			'selected_jenis' => $jenis_laporan,
			'selected_format' => $format_laporan,
			'datafilter' => $this->M_laporan_gugatan->get_laporan_print($jenis_laporan, $lap_bulan, $lap_tahun),
			'summary_data' => $this->M_laporan_gugatan->get_summary_bulanan($lap_bulan, $lap_tahun),
		];
