		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h5>JUMLAH DATA PERCERAIAN KABUPATEN HULU SUNGAI UTARA</h5>
						</div>
						<div class="col-sm-6">
						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<form action="<?php echo base_url() ?>index.php/Data_Perceraian_hsu" method="POST">
										Laporan Bulan :
										...
										<tbody>
											...
											foreach ($datafilter as $row) : ?>
												<tr>
													...
													<td><?php echo $row->PERKARA_PUTUS; ?></td>
													<td><?php echo $row->PERKARA_TELAH_BHT; ?></td>
													<td><?php echo $row->JUMLAH_AKTA_CERAI; ?></td>
												</tr>
											<?php endforeach; ?>
										</tbody>
									</table>
