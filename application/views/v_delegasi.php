						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<form action="<?= base_url() ?>index.php/delegasi" method="POST">
										Laporan Bulan :
										...
										<tbody>
											...
											foreach ($datafilter as $row) : ?>
												<tr>
													...
													<td><?= $row->tgl_penunjukan_jurusita ?></td>
													<td><?= $row->tgl_relaas ?></td>
													<td><?= $row->tgl_pengiriman_relaas ?></td>
													<td><?= $row->jurusita_nama ?></td>
