<body class="hold-transition sidebar-mini">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-6">
                                <div class="small-box bg-info">
                                    <div class="inner">
                                        <h3><?= isset($summary->total_gaib) ? number_format($summary->total_gaib) : 0 ?></h3>
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="small-box bg-success">
                                    <div class="inner">
                                        <h3><?= isset($summary->sudah_putus) ? number_format($summary->sudah_putus) : 0 ?></h3>
                                        <p>Sudah Putus</p>
                                    </div>
                                    <div class="icon">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="small-box bg-danger">
                                    <div class="inner">
                                        <h3><?= isset($summary->belum_putus) ? number_format($summary->belum_putus) : 0 ?></h3>
                                        <p>Belum Putus</p>
                                    </div>
                                    <div class="icon">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card filter-card">
                                ...
                                <div class="card-body">
                                    <form action="<?= base_url() ?>index.php/Perkara_gaib" method="POST" id="filterForm">
                                        <div class="row">
                                            <div class="col-md-2">
                                                ...
                                                <?php if (isset($datafilter) && count($datafilter) > 0): ?>
                                                    ...
                                                    foreach ($datafilter as $row) : ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $row->sidang_pertama ?></td>
                                                            <td>
                                                                <?php if (!empty($row->tanggal_putusan)): ?>
                                                                    <span class="badge badge-success"><?= $row->tanggal_putusan ?></span>
                                                                <?php else: ?>
                                                            ...
                                                            <td>
                                                                <?php if (!empty($row->dokumen_relas)): ?>
                                                                    <?php foreach ($row->dokumen_relas as $dok): ?>
                                                                        <a href="<?= $dok->dokumen_path ?>" target="_blank" class="btn btn-sm btn-outline-primary mb-1" title="Lihat Dokumen Relas">
    ...
    <script>
        ...
        function exportExcel() {
            ...
            form.action = '<?= base_url() ?>index.php/Perkara_gaib/export_excel';
            form.submit();
