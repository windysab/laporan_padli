...
class M_P_Banding extends CI_Model
{
	...
	{
		$sql = "SELECT nomor_perkara_pn, putusan_pn, permohonan_banding, 
				pemberitahuan_inzage, pengiriman_berkas_banding, putusan_banding, 
				penerimaan_kembali_berkas_banding, pemberitahuan_putusan_banding 
			FROM perkara
